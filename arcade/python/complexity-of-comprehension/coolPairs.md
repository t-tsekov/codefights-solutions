<div class="markdown"><p>A pair of numbers is considered to be <em>cool</em> if their product is divisible by their sum. More formally, a pair <code>(i, j)</code> is <em>cool</em> if and only if <code>(i * j) % (i + j) = 0</code>.</p>
